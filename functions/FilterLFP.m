function filtered = FilterLFP(lfp,nyquist,varargin)
...
% 					case 'gamma',
% 						passband = [30 80];
% add by me to separate two gamma components
                    case 'gammaL',
 						passband = [25 45];
                    case 'gammaH',
 						passband = [65 140];
...
filtered = Filter(nyquist,lfp,'passband',passband,varargin{:});